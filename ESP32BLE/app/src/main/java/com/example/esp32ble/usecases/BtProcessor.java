...
public class BtProcessor {
    ...
    // コンストラクタ達
    public BtProcessor(BleTestActivity bleTest, LineChartController controller) {
        this.bleTest = bleTest;
        this.chartController = controller;
    }

    public BtProcessor(BleGameActivity bleGame) { this.bleGame = bleGame; }
                    ...
                    if (listData.length == 1) {
                        ...
                        if (bleTest != null) {
                            if (bleTest.callBleTestData) {
                                chartController.addAccelDataAsync(xData, yData, zData);
                            }
                        } else if (bleGame != null) {
