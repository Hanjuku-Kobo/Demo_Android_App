...
object VisualizationUtils {
    ...
    fun drawBodyKeypoints(
        ...
        persons.forEach { person ->
            ...
            val poseDataProcess = PoseDataProcess()
            poseDataProcess.addForAnalysis(poseDataProcess.getAngle(pointF[0], pointF[2], pointF[4]))
            poseDataProcess.addForAnalysis(poseDataProcess.getAngle(pointF[1], pointF[3], pointF[5]))
